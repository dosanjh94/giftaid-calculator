...
namespace JG.FinTechTest
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "Gift Aid API", Version = "v1" });
                c.IncludeXmlComments(string.Format(@"{0}\JG.FinTechTest.xml", System.AppDomain.CurrentDomain.BaseDirectory));
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Gift Aid API V1");
            });
